...
class _AdminMangaTabState extends State<AdminMangaTab> {
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () =>
                        _showMangaDialog(context, provider, creators, tags),
                      ...
                      child: Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      AdminChapterScreen(manga: manga),
                                ),
                              );
                            },
                          ),
                          IconButton(
                            ...
                            onPressed: () => _showMangaDetailDialog(
                              context,
                              manga,
                              creators,
                              tags,
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                _confirmDelete(context, provider, manga),
                          ),
                        ],
                      ),
                    );
  ...
  void _confirmDelete(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to delete the manga series "${manga.title}"? This will delete all its chapters as well.',
  ...
  void _showMangaDetailDialog(
    ...
    final mangaCreators = manga.creatorIds.map((id) {
      final creator = allCreators.firstWhere(
        (c) => c.id == id,
        orElse: () => Creator(id: id, name: 'Unknown Creator', slug: ''),
      );
      return creator.name;
    }).toList();
    ...
    final mangaTags = manga.tags.map((id) {
      return allTags.firstWhere(
        (t) => t.id == id,
        orElse: () =>
            Tag(id: id, name: 'Unknown Tag', slug: '', group: 'THEME'),
      );
    }).toList();
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  color: manga.status.toUpperCase() == 'ONGOING'
                                      ? AdminColors.green
                                      : AdminColors.warningYellow,
                                  child: Text(
                                    manga.status.toUpperCase(),
                      ...
                      children: mangaTags.map((tag) {
                        ...
                        return Chip(
                          label: Text(
                            ...
                            style: TextStyle(
                              fontSize: 11,
                              color: isGenre ? Colors.white : Colors.black,
                            ),
                          ),
                          backgroundColor: isGenre
                              ? AdminColors.shonenPurple
                              : AdminColors.cyberCyan,
                          padding: EdgeInsets.zero,
                          materialTapTargetSize:
                              MaterialTapTargetSize.shrinkWrap,
  ...
  void _showMangaDialog(
    ...
    final titleController = TextEditingController(
      text: existingManga?.title ?? '',
    );
    final slugController = TextEditingController(
      text: existingManga?.slug ?? '',
    );
    final descController = TextEditingController(
      text: existingManga?.description ?? '',
    );
    ...
    List<String> selectedCreatorIds = List.from(
      existingManga?.creatorIds ?? [],
    );
                  ...
                  child: Column(
                    ...
                    children: [
                              ...
                              onPressed: () async {
                                ...
                                if (image != null) {
                                  try {
                                    ...
                                    final url = await UploadApiService()
                                        .uploadImage(image);
                                    setState(() {
                                      coverUrl = url;
                                    });
                      ...
                      if (allCreators.isEmpty)
                        const Text(
                          'No creators available. Please create creators first.',
                          style: TextStyle(
                            color: AdminColors.onSurfaceVariant,
                            fontSize: 12,
                          ),
                        ...
                        Wrap(
                          ...
                          children: allCreators.map((creator) {
                            final isSelected = selectedCreatorIds.contains(
                              creator.id,
                            );
                            return FilterChip(
                              label: Text(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 10,
                                      color: groupName.toUpperCase() == 'GENRE'
                                          ? AdminColors.shonenPurple
                                  ...
                                  Wrap(
                                    ...
                                    children: groupTags.map((tag) {
                                      final isSelected = selectedTagIds
                                          .contains(tag.id);
                                      final isGenre =
                                          tag.group.toUpperCase() == 'GENRE';
                                      return FilterChip(
                                        label: Text(
                                          tag.name,
                                          style: TextStyle(
                ...
                ElevatedButton(
                  onPressed: provider.isLoading
                      ...
                      : () async {
                          ...
                          bool success;
                          if (isEdit) {
                            success = await provider.updateManga(
                              existingManga.id,
                              mangaData,
                            );
                          } else {
